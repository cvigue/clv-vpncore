#!/bin/bash
# test_it20_ovpn_client_v2.sh — IT20: simple_vpn V2 force-cookie server + openvpn client
#
# vpncore tls-crypt-v2 server with force-cookie receives an OpenVPN 2.6+ client.
# Asserts psid cookie challenge/accept on the server.
#
# Usage: sudo ./test_it20_ovpn_client_v2.sh [PROJECT_ROOT]
...
SERVER_CONFIG="${PROJECT_ROOT}/integration/configs/it_server_v2_force_cookie.json"
OVPN_CLIENT_CONF="${SCRIPT_DIR}/configs/openvpn/it20_client_v2.conf"
...
echo "=== IT20: simple_vpn V2 force-cookie Server + OpenVPN Client ==="
