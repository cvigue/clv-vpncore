...
class SessionManager
{
  public:
    ...
    /**
     * @brief Extract a session (remove from manager but return ownership).
     * @param session_id The session to extract
     * @return The extracted Connection, or nullptr if not found.
     */
    std::unique_ptr<Connection> ExtractSession(openvpn::SessionId session_id);
