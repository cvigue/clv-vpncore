...
| IT12 | TLS-Crypt-V2 single-client handshake. Validates early-neg + psid cookie + `P_CONTROL_WKC_V1` WKc resend, per-session TlsCrypt key derivation, and end-to-end tunnel ping. |
